...
import { userService, questionService, evaluationService, templateService } from '@/lib/firestore';
...
export default function AdminAssignmentsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.evaluatorId || !formData.evaluateeId || formData.questions.length === 0) {
    ...
    try {
      ...
      const selectedQuestions = questions.filter(q => formData.questions.includes(q.id));
  ...
  const getEvaluationTypeDisplayName = (type: string) => {
    switch (type) {
      case 'peer': return 'Peer to Peer';
      case 'manager_to_employee': return 'Manager to Employee';
      case 'employee_to_manager': return 'Employee to Manager';
      default: return type;
    }
  };
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="mb-8 bg-white rounded-lg border border-gray-200 p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="manager_to_employee">Manager to Employee</option>
                      <option value="employee_to_manager">Employee to Manager</option>
                    </select>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label htmlFor="evaluatorId" className="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    >
                      ...
                      {users.map((user) => (
                        <option key={user.uid} value={user.uid}>
                          {user.displayName || user.email} ({getRoleDisplayName(user.role)})
                        </option>
                      ))}
                    </select>
                  </div>
                  ...
                  <div>
                    <label htmlFor="evaluateeId" className="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            if (e.target.checked) {
                              ...
                              setFormData({
                                ...formData,
                                questions: formData.questions.filter(id => id !== question.id)
                              });
                            }
                          }}
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
            <h3 className="text-lg font-medium text-blue-800 mb-3">How to Assign Evaluations</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-4">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-500">Ready to Assign</p>
